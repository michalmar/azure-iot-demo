...
namespace Microsoft.Azure.Devices.Client.Samples
{
    public class Program
    {
        ...
        private static string s_deviceConnectionString = "HostName=mma-demo-iothub.azure-devices.net;DeviceId=MyDotnetDevice;SharedAccessKey=/5XI3FebxopCsbDiQ7v9Y3KHNBdkKyMgPdd9gmTZcbE="; //Environment.GetEnvironmentVariable("IOTHUB_DEVICE_CONN_STRING");
